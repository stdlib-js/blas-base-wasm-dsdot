...
// Attached to the main export is a `main` method which returns a number...
{
	...
	dsdot.main( x.length, x, 1, y, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	dsdot.main( '10', x, 1, y, 1 ); // $ExpectError
	dsdot.main( true, x, 1, y, 1 ); // $ExpectError
	dsdot.main( false, x, 1, y, 1 ); // $ExpectError
	dsdot.main( null, x, 1, y, 1 ); // $ExpectError
	dsdot.main( undefined, x, 1, y, 1 ); // $ExpectError
	dsdot.main( [], x, 1, y, 1 ); // $ExpectError
	dsdot.main( {}, x, 1, y, 1 ); // $ExpectError
	dsdot.main( ( x: number ): number => x, x, 1, y, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float32Array...
{
	...
	dsdot.main( x.length, 10, 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, '10', 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, true, 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, false, 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, null, 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, undefined, 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, [], 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, {}, 1, y, 1 ); // $ExpectError
	dsdot.main( x.length, ( x: number ): number => x, 1, y, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	dsdot.main( x.length, x, '10', y, 1 ); // $ExpectError
	dsdot.main( x.length, x, true, y, 1 ); // $ExpectError
	dsdot.main( x.length, x, false, y, 1 ); // $ExpectError
	dsdot.main( x.length, x, null, y, 1 ); // $ExpectError
	dsdot.main( x.length, x, undefined, y, 1 ); // $ExpectError
	dsdot.main( x.length, x, [], y, 1 ); // $ExpectError
	dsdot.main( x.length, x, {}, y, 1 ); // $ExpectError
	dsdot.main( x.length, x, ( x: number ): number => x, y, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fourth argument which is not a Float32Array...
{
	...
	dsdot.main( x.length, x, 1, 10, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, '10', 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, true, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, false, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, null, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, undefined, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, [], 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, {}, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fifth argument which is not a number...
{
	...
	dsdot.main( x.length, x, 1, y, '10' ); // $ExpectError
	dsdot.main( x.length, x, 1, y, true ); // $ExpectError
	dsdot.main( x.length, x, 1, y, false ); // $ExpectError
	dsdot.main( x.length, x, 1, y, null ); // $ExpectError
	dsdot.main( x.length, x, 1, y, undefined ); // $ExpectError
	dsdot.main( x.length, x, 1, y, [] ); // $ExpectError
	dsdot.main( x.length, x, 1, y, {} ); // $ExpectError
	dsdot.main( x.length, x, 1, y, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	dsdot.main(); // $ExpectError
	dsdot.main( x.length ); // $ExpectError
	dsdot.main( x.length, x ); // $ExpectError
	dsdot.main( x.length, x, 1 ); // $ExpectError
	dsdot.main( x.length, x, 1, y ); // $ExpectError
	dsdot.main( x.length, x, 1, y, 1, 10 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	dsdot.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	dsdot.Module( '10' ); // $ExpectError
	dsdot.Module( true ); // $ExpectError
	dsdot.Module( false ); // $ExpectError
	dsdot.Module( null ); // $ExpectError
	dsdot.Module( undefined ); // $ExpectError
	dsdot.Module( [] ); // $ExpectError
	dsdot.Module( {} ); // $ExpectError
	dsdot.Module( ( x: number ): number => x ); // $ExpectError
}
