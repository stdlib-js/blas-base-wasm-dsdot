...
```javascript
dsdot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-dsdot@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-wasm-dsdot/tags). For example,

```javascript
dsdot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-dsdot@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dsdot = require( 'path/to/vendor/umd/blas-base-wasm-dsdot/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-dsdot@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-base-wasm-dsdot.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-base-wasm-dsdot

[test-image]: https://github.com/stdlib-js/blas-base-wasm-dsdot/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-wasm-dsdot/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-base-wasm-dsdot/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-base-wasm-dsdot?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-base-wasm-dsdot.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-base-wasm-dsdot/main
...
[branches-url]: https://github.com/stdlib-js/blas-base-wasm-dsdot/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-base-wasm-dsdot/main/LICENSE
